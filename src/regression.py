...
Use the same arguments as src.run, with STUDY_WORK pointing at a fresh directory.
...
from . import network_mesh, run


def main():
    assert Path(network_mesh.__file__).resolve()==ROOT/'src/network_mesh.py'
